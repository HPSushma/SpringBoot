...
public class MatchInput {
    ...
    public MatchInput(String id, String city, String date, String player_of_match, String venue, String neutral_venue,
            String team1, String team2, String toss_winner, String toss_decision, String match_winner, String result,
            String result_margin, String method, String eliminator, String umpire1, String umpire2) {
        this.id = id;
        this.city = city;
        this.date = date;
        this.player_of_match = player_of_match;
